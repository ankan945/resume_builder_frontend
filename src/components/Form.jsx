...
const Form = () => {
  ...
  const handleDownloadPdf = async () => {
    try {
      ...
      const createResponse = await axios.post("https://resume-builder-backend-6.onrender.com/create-pdf", formData);
      
      // Check if PDF creation was successful
      if (createResponse.status === 200) {
        // Step 2: Fetch the created PDF
        const fetchResponse = await axios.get("https://resume-builder-backend-6.onrender.com/fetch-pdf", {
          responseType: "blob",
        });
